...
{givenScript}
  ...
  <body>
    <div id="path" style="display: flex; align-items: center; justify-content: space-between;">
      <div>
        {path}
      </div>
      <button id="settingsButton" aria-label="Settings" style="background:none;border:none;cursor:pointer;padding:4px;">
